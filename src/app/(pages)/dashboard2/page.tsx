...
import { notification } from 'antd'  // Sadece notification Ant Design'dan alındı
    ...
    <>
      {
        ...
        <div className="relative w-screen h-screen overflow-hidden">
          {loading || backgroundImage && <Background src={backgroundImage} loading={loading} />}
              ...
              <TabGroup as="div" className="active:bg-transparent text-white" onChange={handleTabChange}>
                <TabList className="flex">
                  <Tab className={({ selected }) =>
                    clsx(
                      'relative px-4 py-2 text-sm font-medium leading-5 text-white focus-visible:outline-none cursor-pointer', // focus-visible devre dışı
