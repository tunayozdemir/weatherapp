...
const ApiKeyPrompt: React.FC<ApiKeyPromptProps> = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const formData = new FormData(event.currentTarget); // Formdan verileri al
    const apiKey = formData.get('apiKey') as string; // FormData'dan API Key'i al
